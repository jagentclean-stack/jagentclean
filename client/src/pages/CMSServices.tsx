...
const blankDraft = (): ServiceDraft => ({
  name: "", slug: "", description: "", process: "", icon: "", bannerImage: "", video: "",
...
export default function CMSServices() {
  ...
  function openEdit(service: NonNullable<typeof services>[number]) {
    ...
    setDraft({
      name: service.name, slug: service.slug, description: stringValue(service.description), process: stringValue(service.process),
