...
import { AlertCircle, CheckCircle2, Loader2, Pencil, ShieldCheck, UserPlus, UsersRound } from "lucide-react";
...
export default function CMSUsers() {
  ...
  const busy = create.isPending || updateRole.isPending || setActive.isPending || updateProfile.isPending;
