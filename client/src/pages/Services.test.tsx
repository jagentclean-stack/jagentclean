...
describe("公開服務價格展示", () => {
  it("顯示已發布服務的最低價、單位價格、優惠與報價備註", () => {
    state.data = [{ id: 1, name: "居家清潔", description: "專業居家清潔", basePrice: "2000", pricePerUnit: "500", unit: "坪", promotion: "首次預約優惠", priceNote: "實際費用依現場確認。" }];
    render(<Services />);
  ...
  it("服務尚未設定價格時不顯示價格區塊", () => {
    state.data = [{ id: 2, name: "水塔清洗", description: "專業水塔清洗", basePrice: null, pricePerUnit: null, unit: null, promotion: null, priceNote: null }];
    render(<Services />);
